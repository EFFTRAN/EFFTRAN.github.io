...
**To download** the latest version of EFFTRAN (currently 4.7.1) follow [**this link**](https://efftran.github.io/EFFTRAN_4.7.2.zip). Click [**here**](https://efftran.github.io/MEFFTRAN_1.6.zip) for a copy of MEFFTRAN (currently version 1.6).
