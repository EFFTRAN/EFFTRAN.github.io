...
EFFTRAN application is limited to coaxial and planar detectors and to cylindrical samples. A separate version called MEFFTRAN exists for dealing with Marinelli beakers.
...
To download the latest version of EFFTRAN (currently 4.7.1) follow [this link](https://efftran.github.io/EFFTRAN_4.7.1.zip). Click [here](https://efftran.github.io/MEFFTRAN_1.6.zip) for a copy of MEFFTRAN (currently 1.6).
